...
CREATE TABLE CONVOCATORIA_EXAMEN(
	ID_CONVOCATORIA_EXAMEN INT PRIMARY KEY,
	ID_ENUNCIADO INT,
...
(1, 'Problema de álgebra lineal', 'ALTA', TRUE, './src/assets/problem1.jpg'),
(2, 'Ejercicio de cinemática', 'MEDIA', TRUE, './src/assets/problem2.jpg');
...
SELECT * FROM ENUNCIADO WHERE ID_ENUNCIADO = (SELECT ID_ENUNCIADO FROM ASIGNAR WHERE ID_UNIDAD =1);
SELECT * FROM CONVOCATORIA_EXAMEN WHERE ID_ENUNCIADO = 1;